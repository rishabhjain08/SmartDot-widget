...
/**
 * Theme class for local (non-shared) installation of the library.
 */
/*---------------------------------------------------------------------*/
...
Yahoo.Controls.Theme.prototype._theme_getThemes = function() {
    ...
    // HACK: Hard coded values for flat file support
	this._themes.push("Purple");
	this._themes.push("Black Glass");
}
